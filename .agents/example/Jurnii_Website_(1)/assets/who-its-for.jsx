...
const ICPS = [
  {
    ...
    products: ['Jurnii 360', 'Jurnii MMM'],
    callouts: [
  ...
  },
  {
    ...
    products: ['Jurnii MMM', 'Jurnii 360'],
    callouts: [
    ...
    <article className={`icp-detail reveal ${icp.accent || ''}`} key={icp.slug}>
      ...
      <div className="icp-grid">
        ...
        <div className="icp-section">
          ...
          <a className="btn primary" href="contact.html" style={{marginTop:20, justifyContent:'center'}}>Book a demo <i data-lucide="arrow-right" style={{width:14,height:14}} className="arrow"/></a>
        </div>
      </div>
