...
window.RESOURCE_BODIES = {
  'jurnii-vs-ekimetrics': {
    ...
    sections: [
      ...
      { h: 'The decision', p: ['If iGaming is your business — not one of three or four lines — Cortex gives you a model that understands the drivers. If iGaming is one of several, Ekimetrics may give you the cross-sector view you need.','Either way, a competent operator should run a data-readiness assessment before signing anything. We do ours free; theirs is part of scoping.'] },
    ],
    related: ['mmm-data-readiness-igaming','jurnii-vs-nielsen','tier-1-operator-promo-waste-reduction'],
  },
  'jurnii-vs-nielsen': {
    tldr: ['Nielsen MMM is the FMCG gold standard. Decades of pedigree, panel data, and credibility.','iGaming variables (bonus mechanics, sporting calendars, regulatory shocks, competitor promo intensity) are not in their core model.','For operators, that means coefficients on TV and digital that look fine in isolation but don\'t add up to a defensible P&L explanation.','Cortex models those variables as first-class inputs.'],
    sections: [
      ...
      { h: 'When to choose Jurnii', p: ['When the questions you\'re asking are: "Is paid social saturated?" "Should we cut reload offers?" "What\'s the marginal ROI on the next pound into TV during Cheltenham?" — these are the questions Cortex was built to answer.'] },
    ],
