// ============================================================
// Feature leaf-page TEMPLATE. One component renders every
// individual feature page from window.FEATURE_DATA[slug].
// Edit here once → every page updates.
//   <FeaturePage slug="competitor-promotions" />
// ============================================================

const FeaturePage = ({ slug }) => {
  const d = window.FEATURE_DATA[slug];
  const S = window.FEATURE_SHARED;
  const cat = window.FEATURE_CATS[d.cat];
      ...
      <section className="uc-eco section reveal">
        <div className="container">
          ...
          <div className="uc-eco-grid">
            ...
            <div>
              <h3 className="uc-eco-col-label">Related Features</h3>
              <div className="uc-eco-links">
                {siblings.map((sib) =>
