---
title: Competitor Promotions Index
description: Database of daily competitor promotion capture with structured metadata.
category: Competitor
order: 10
icon: 'lucide:Zap'
heroFeatures:
...
pullQuote: >-
  Never let a competitor promotion go unnoticed. Jurnii monitors active sign-up
  offers across key regulated jurisdictions, helping operators calibrate
  margins, protect Net Gaming Revenue (NGR), and acquire players dynamically in
